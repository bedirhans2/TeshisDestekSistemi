...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Teşhis Destek Sistemi Giriş");
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 204)), "Login"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(txt_user.getText().equals(username) && txt_pass.getText().equals(password)) {
            ...
            JOptionPane.showMessageDialog(null, "Hatalı Kullanıcı Adı veya Parola girdiniz, tekrar deneyin");
